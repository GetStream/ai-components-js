...
/**
 * JNI C++ class for module 'NativeAIDictation'
 */
class JSI_EXPORT NativeAIDictationSpecJSI : public JavaTurboModule {
public:
  NativeAIDictationSpecJSI(const JavaTurboModule::InitParams &params);
};
